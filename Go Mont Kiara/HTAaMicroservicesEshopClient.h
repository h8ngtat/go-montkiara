 ...
 */
@interface HTAaMicroservicesEshopClient: AWSAPIGatewayClient
 ...
 *Swift*
     ...
     let serviceClient = HTAaMicroservicesEshopClient.defaultClient()

 *Objective-C*

     HTAaMicroservicesEshopClient *serviceClient = [HTAaMicroservicesEshopClient defaultClient];

 Alternatively, this configuration could also be set in the `info.plist` file of your app under `AWS` dictionary with a configuration dictionary by name `HTAaMicroservicesEshopClient`.
 ...
 *Swift*
     ...
     func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
         ...
         HTAaMicroservicesEshopClient.registerClientWithConfiguration(configuration, forKey: "USWest2HTAaMicroservicesEshopClient")
 ...
 *Swift*
     ...
     let serviceClient = HTAaMicroservicesEshopClient(forKey: "USWest2HTAaMicroservicesEshopClient")

 *Objective-C*

     HTAaMicroservicesEshopClient *serviceClient = [HTAaMicroservicesEshopClient clientForKey:@"USWest2HTAaMicroservicesEshopClient"];
