 ...
 */
@interface HTAaMicroservicesAccountClient: AWSAPIGatewayClient
 ...
 *Swift*
     ...
     let serviceClient = HTAaMicroservicesAccountClient.defaultClient()

 *Objective-C*

     HTAaMicroservicesAccountClient *serviceClient = [HTAaMicroservicesAccountClient defaultClient];

 Alternatively, this configuration could also be set in the `info.plist` file of your app under `AWS` dictionary with a configuration dictionary by name `HTAaMicroservicesAccountClient`.
 ...
 *Swift*
     ...
     func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
         ...
         HTAaMicroservicesAccountClient.registerClientWithConfiguration(configuration, forKey: "USWest2HTAaMicroservicesAccountClient")
 ...
 *Swift*
     ...
     let serviceClient = HTAaMicroservicesAccountClient(forKey: "USWest2HTAaMicroservicesAccountClient")

 *Objective-C*

     HTAaMicroservicesAccountClient *serviceClient = [HTAaMicroservicesAccountClient clientForKey:@"USWest2HTAaMicroservicesAccountClient"];
